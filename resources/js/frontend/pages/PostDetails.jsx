...
const PostDetails = ({ url }) => {
    const { MAIN_URL, loading, setLoading, loggedinAdmin, removeHtmlTags } = useContext(SiteContext);
                            ...
                            <div className=''>
                                ...
                                <div className='flex items-center justify-between'>
                                    <div className=' py-2'>
                                        ...
                                        <p className='text-sm'>{postData?.updated_at && formatDate(postData?.updated_at)}</p>
                                    </div>
                                    <div>
